...
impl TypeSignature {
    ...
    fn inner_size(&self) -> Option<u32> {
        match self {
            ...
            CallableType(CallableSubtype::Trait(_)) | Self::TraitReferenceType(_) => Some(276), // 20+128+128
        }
    }
    ...
    fn inner_type_size(&self) -> Option<u32> {
        match self {
            ...
            CallableType(_) | ListUnionType(_) | Self::TraitReferenceType(_) => Some(1),
        }
    }
}
...
impl fmt::Display for TypeSignature {
    fn fmt(&self, f: &mut fmt::Formatter) -> fmt::Result {
        match self {
            ...
            CallableType(CallableSubtype::Trait(trait_id)) | Self::TraitReferenceType(trait_id) => {
                write!(f, "<{}>", trait_id)
            }
